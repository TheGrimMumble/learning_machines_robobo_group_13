...
class RoboboGymEnv(gym.Env):
    def __init__(self, rob: IRobobo):
        ...
        header = ['Universal_step', 'Step_in_Episode', 'collision', 'x pos', 'y pos','BR', 'BL', 'FR2', 'FL2', 'FM', 'BL1', 'BM', 'FR1', 'ls', 'rs', 'proximity_penalty', 'forward_speed_reward', 'Final_reward']
    ...
    def step(self, action):
        ...
        # save info
        row = [info['Universal step'], info['Step in Episode'], info['collision'], info['x pos'], info['y pos'],
            info['BR'], info['BL'], info['FR2'], info['FL2'], info['FM'], 
            info['BL1'], info['BM'], info['FR1'], info['ls'], 
            info['rs'], info['proximity_penalty'], 
            info['forward_speed_reward'], info['Final reward']]
