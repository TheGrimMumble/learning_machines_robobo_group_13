...
class RoboboGymEnv(gym.Env):
    def __init__(self, rob: IRobobo):
        ...
        self.previous_orientation_distance = None
    ...
    def orientation_distance_reward(self, choice: str):
        ...
        previous_dist_rob = self.previous_orientation_distance
        ...
        if stub > left_right_mean:
            ...
            if diff > 0.005:
                reward += diff * 50
            reward += 1 - abs(direction)
        else:
            reward += abs(direction)
        self.previous_orientation_distance = dist_rob
